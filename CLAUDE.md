...
- `alembic/` — 42 revisions (head: `c8a_playbook_topology`); `env.py` imports all model modules and runs seeds after upgrade
...
- `tests/` — 16 files, ~90 tests (`asyncio_mode = auto`, SQLite)
